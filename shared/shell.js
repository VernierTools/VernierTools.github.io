...
(function () {
  ...
  var COMMON = {
    en: {
      "cat.general":"General","cat.text":"Text","cat.image":"Image","cat.3dcg":"Blender","cat.audio":"Audio",
    ...
    ja: {
      "cat.general":"ジェネラル","cat.text":"文章","cat.image":"画像","cat.3dcg":"Blender","cat.audio":"音声",
